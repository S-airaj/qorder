...
export default class AddCategoryScreen extends React.Component<Props, State> {
    ...
    addCategory = () => {
        CategoryService.addCategory({
            Name: this.state.Name, OrganizationId: this.state.Organization,
            Url: this.state.Url, Description: this.state.Description
        })
            .then((response: any) => {
                this.setState({ isLoading: false });
                this.props.navigation.navigate({ "name": "Edit Category", params: { Id: response.Result } });
                    ...
                    <ScrollView showsVerticalScrollIndicator={false}>
                        <View style={styles.flexMiddle}>
                            ...
                            <Pressable style={styles.addButton}>
                                <Button color="primary" onPress={this.addCategory}>
